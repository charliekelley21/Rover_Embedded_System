...
const uint_least8_t slave_select_1_CONST = slave_select_1;
const uint_least8_t slave_select_2_CONST = slave_select_2;
const uint_least8_t slave_select_3_CONST = slave_select_3;
const uint_least8_t DEBUG_0_CONST = DEBUG_0;
const uint_least8_t DEBUG_1_CONST = DEBUG_1;
const uint_least8_t DEBUG_2_CONST = DEBUG_2;
const uint_least8_t DEBUG_3_CONST = DEBUG_3;
const uint_least8_t DEBUG_4_CONST = DEBUG_4;
const uint_least8_t DEBUG_5_CONST = DEBUG_5;
...
const uint_least8_t motor_driver_uart_CONST = motor_driver_uart;
