...
const uint_least8_t CONFIG_GPIO_DEBUG_1_CONST = CONFIG_GPIO_DEBUG_1;
const uint_least8_t CONFIG_GPIO_DEBUG_2_CONST = CONFIG_GPIO_DEBUG_2;
const uint_least8_t CONFIG_GPIO_DEBUG_3_CONST = CONFIG_GPIO_DEBUG_3;
const uint_least8_t CONFIG_GPIO_DEBUG_4_CONST = CONFIG_GPIO_DEBUG_4;
const uint_least8_t CONFIG_GPIO_DEBUG_5_CONST = CONFIG_GPIO_DEBUG_5;
const uint_least8_t CONFIG_GPIO_DEBUG_6_CONST = CONFIG_GPIO_DEBUG_6;
const uint_least8_t CONFIG_GPIO_DEBUG_7_CONST = CONFIG_GPIO_DEBUG_7;
const uint_least8_t CONFIG_GPIO_DEBUG_0_CONST = CONFIG_GPIO_DEBUG_0;
